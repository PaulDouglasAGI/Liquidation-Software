    ...
    <div className="space-y-3">
      ...
      <PalletEditor
        pallet={{
          ...
          pickupDate: pallet.pickupDate?.toISOString() ?? null,
          totalCost: cost,
          fees: pallet.fees.toNumber(),
          manifestUrl: pallet.manifestUrl,
          category: pallet.category,
          conditionGrade: pallet.conditionGrade,
          manifestUnitCount: pallet.manifestUnitCount,
          actualUnitCount: pallet.actualUnitCount,
          manifestRetailTotal: num(pallet.manifestRetailTotal),
          preBidEstimatedRecovery: num(pallet.preBidEstimatedRecovery),
